...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(52, 50, "end", "model_yapa");
    return reader;
}
...
private:
        ...
        double poll_dev_sigma;
        double trend_dev_sigma;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "poll_dev_sigma", "double", context__.to_vec());
            poll_dev_sigma = double(0);
            vals_r__ = context__.vals_r("poll_dev_sigma");
            pos__ = 0;
            poll_dev_sigma = vals_r__[pos__++];
            check_greater_or_equal(function__, "poll_dev_sigma", poll_dev_sigma, 0);
            current_statement_begin__ = 9;
            context__.validate_dims("data initialization", "trend_dev_sigma", "double", context__.to_vec());
            trend_dev_sigma = double(0);
            vals_r__ = context__.vals_r("trend_dev_sigma");
            pos__ = 0;
            trend_dev_sigma = vals_r__[pos__++];
            check_greater_or_equal(function__, "trend_dev_sigma", trend_dev_sigma, 0);
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(normal_log<propto__>(alpha, prior_pct, alpha_sigma));
            current_statement_begin__ = 34;
            lp_accum__.add(normal_log<propto__>(alpha_sigma, 0, 0.5));
            current_statement_begin__ = 35;
            lp_accum__.add(normal_log<propto__>(theta_sigma, 0, poll_dev_sigma));
            current_statement_begin__ = 36;
            lp_accum__.add(normal_log<propto__>(delta_sigma, 0, trend_dev_sigma));
